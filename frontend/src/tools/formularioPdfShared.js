...
/** Carrega logo em base64 para PDF nítido (prévia iframe + impressão) */
export async function loadLogoDataUrl(baseUrl = '') {
  const url = resolveAssetUrl(BRAND.logoPath, baseUrl);
  try {
  ...
  return `
    <header class="page-header-bar">
      <div class="page-header-left">
        <img class="page-header-logo" src="${escapeHtml(logoUrl)}" alt="${escapeHtml(BRAND.nome)}" />
    ...
    <div class="pdf-page pdf-page-capa" data-pdf-page="1">
      ...
      <div class="capa-inner">
        <div class="capa-logo-wrap">
          <img class="capa-logo" src="${escapeHtml(logoUrl)}" alt="${escapeHtml(BRAND.nome)}" />
        </div>
