...
<div class="relatorios-dashboard">
  ...
  <section class="recent-section" aria-labelledby="recent-projetos-heading">
    <h2 id="recent-projetos-heading">Relatórios recentes</h2>
    ...
    {#if filteredRelatorios.length === 0}
      <div class="empty-state" role="status">
        ...
        {:else}
          <p>Ainda não há relatórios salvos.</p>
          <p class="empty-hint">
            Os relatórios gerados e enviados aparecerão aqui. Use &ldquo;Novo relatório&rdquo; para
            criar o primeiro.
          </p>
        {/if}
      </div>
